        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0 shadow">
            <div class="card-header text-center pt-4">
              <img src="{{ asset('assets/img/checklist.svg') }}" width="128">
            ...
            <div class="card-body">
              <form role="{{ route('login') }}" method="POST">
                @csrf
               <div class="form-group mb-3">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" id="btnLogIn">Sign In <i class="fas fa-sign-in-alt"></i> </button>
                </div>
                <p class="text-sm mt-3 mb-0 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-dark font-weight-bolder">Sign Up</a></p>
              </form>
            </div>
          </div>
        </div>
